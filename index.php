...
<body>
                ...
                <div class="modal-body">
                    <div id="menumodal">
                        <nav>
                            <ul>
                                <li>
                                    <h2><a href="index.php" class="lienscol liensmodal">Nos offres immobilières</a></h2>
                                </li>
                                <li>
                                    <h2><a href="#contactform" class="lienscol liensmodal" id="contact">Nous contacter</a></h2>
                                </li>
                                <li>
                                    <form id="modalsearch">
                                        <input type="hidden" value="search" name="controller">
                                        <input type="research" placeholder="Ma recherche..." name="research" id="modalinput">
    ...
    <main>
        ...
        <div class="grid">
            ...
            <!-- cartes type surface -->
            <div class="cache villa-surfacecrois">
                <?php
            ...
            <div class="cache maison-surfacecrois">
                <?php
            ...
            <div class="cache cabane-surfacecrois">
                <?php
            ...
            <div class="cache appartement-surfacecrois">
                <?php
            ...
            <div class="cache villa-surfacedes">
                <?php
            ...
            <div class="cache maison-surfacedes">
                <?php
            ...
            <div class="cache cabane-surfacedes">
                <?php
            ...
            <div class="cache appartement-surfacedes">
                <?php
            ...
            <!-- cartes type prix -->
            <div class="cache villa-prixcrois">
                <?php
            ...
            <div class="cache maison-prixcrois">
                <?php
            ...
            <div class="cache cabane-prixcrois">
                <?php
            ...
            <div class="cache appartement-prixcrois">
                <?php
            ...
            <div class="cache appartement-prixdes">
                <?php
            ...
            <div class="cache maison-prixdes">
                <?php
            ...
            <div class="cache cabane-prixdes">
                <?php
            ...
            <!-- surface prix -->
            <div class="cache surfacecrois-prixcrois">
                <?php
            ...
            <div class="cache surfacecrois-prixdes">
                <?php
            ...
            <div class="cache surfacedes-prixdes">
                <?php
            ...
            <div class="cache surfacedes-prixcrois">
                <?php
